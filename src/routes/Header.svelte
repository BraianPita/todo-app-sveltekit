<script>
	...
	import { Navbar, NavBrand, Tooltip, NavHamburger, Button, Input } from 'flowbite-svelte'
  </script>
  
  <Navbar class="!bg-primary !py-1 text-bgcolor" let:hidden let:toggle>
	<NavBrand href="/">
	  <img
		src={logo}
	...
	<div class="flex md:order-2">
	  <Button data-collapse-toggle="mobile-menu-3" aria-controls="mobile-menu-3" aria-expanded="false" class="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1" >
